...
function op_table(): array {
    return [
        ...
        'set_friends'    => fn($t, $a) => t_set_friends($t, $a),
...
case 'help':
    json_out([
        ...
        'ops' => [
            ...
            'set_friends'    => ['args' => ['match|classId' => 'class', 'on' => 'bool — show classmates (first name + pirate character, no scores) on each student\'s map'], 'example' => ['op' => 'set_friends', 'match' => 'ג׳2', 'on' => true]],
